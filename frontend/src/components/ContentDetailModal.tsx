        ...
        {editing ? (
          <div className="mt-4 space-y-3">
            <input
              ...
              className="w-full rounded-md border border-slate-300 dark:border-slate-700 bg-slate-100 dark:bg-slate-800 px-3 py-2 text-sm font-medium outline-none focus:border-brand-500"
              placeholder="Title"
            />
            <textarea
              rows={12}
        ...
        <div className="mt-6 flex justify-end gap-3">
          ...
          {editing ? (
            ...
            <button
              ...
              className="rounded-md bg-brand-500 px-4 py-2 text-sm font-medium hover:bg-brand-400"
            >
              Edit
            </button>
          )}
