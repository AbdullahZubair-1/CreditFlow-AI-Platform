...
export default function CreateOrJoinAccount() {
  ...
  return (
    <AuthLayout title="Create or join an account">
      {accounts.length > 0 && (
        <div className="mb-6">
          <p className="mb-2 text-sm text-slate-400">You already belong to:</p>
          ...
          <button
            ...
            className="mt-4 w-full rounded-md bg-indigo-500 px-4 py-2 font-medium hover:bg-indigo-400"
          >
      ...
      <form onSubmit={handleCreateTeam} className="space-y-3">
        ...
        />
        <button className="w-full rounded-md border border-slate-700 px-4 py-2 font-medium hover:bg-slate-800">
          Create team
        </button>
      </form>
      ...
      <form onSubmit={handleAcceptInvite} className="space-y-3">
        <p className="text-sm text-slate-400">Accept a team invite</p>
        <input
          required
